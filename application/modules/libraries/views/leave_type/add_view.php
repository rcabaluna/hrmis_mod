...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <?=form_open(base_url('libraries/leave_type/add'), array('method' => 'post', 'id' => 'frmLeavetype'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strLeaveType" value="<?=!empty($this->session->userdata('strLeaveType'))?$this->session->userdata('strLeaveType'):''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="control-label">Leave Description <span class="required"> * </span></label>
                                <div class="input-icon right">
                                    <i class="fa"></i>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="intDays" value="<?=!empty($this->session->userdata('intDays'))?$this->session->userdata('intDays'):''?>">
                                </div>
                            </div>
                        </div>
                    </div>
