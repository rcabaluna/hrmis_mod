                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strDescription" value="<?=!empty($arrLeave[0]['description'])?$arrLeave[0]['description']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="intDays" value="<?=!empty($arrLeave[0]['numOfDays'])?$arrLeave[0]['numOfDays']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
