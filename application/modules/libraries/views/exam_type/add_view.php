<?php 
/** 
Purpose of file:    Add page for Exam Type Library
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Add Exam Type</span>
                </div>
                
            </div>
            <div class="portlet-body">
            <?=form_open(base_url('libraries/exam_type/add'), array('method' => 'post', 'id' => 'frmExam'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strExamCode" value="<?=!empty($this->session->userdata('strExamCode'))?$this->session->userdata('strExamCode'):''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strExamDesc" value="<?=!empty($this->session->userdata('strExamDesc'))?$this->session->userdata('strExamDesc'):''?>">
                                </div>
                            </div>
                        </div>
                    </div>
