...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <?=form_open(base_url('libraries/separation_mode/edit/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmSeparation'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="strSepCause" value="<?=isset($arrSeparation[0]['separationCause'])?$arrSeparation[0]['separationCause']:''?>">
