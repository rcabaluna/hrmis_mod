<?php 
/** 
Purpose of file:    Add page for Duties and Responsibilities Library
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Add Duties and Responsibilities</span>
        </li>
    </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Add Duties and Responsibilities</span>
                </div>
                
            </div>
            <div class="portlet-body">
            <?=form_open(base_url('libraries/duties_responsibilities/add'), array('method' => 'post', 'id' => 'frmDutiesResponsibilities'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    ...
                                    <select type="text" class="form-control" name="strPosition" value="<?=!empty($this->session->userdata('strPosition'))?$this->session->userdata('strPosition'):''?>" required>
                                        ...
                                        {
                                          echo '<option value="'.$pos['positionCode'].'">'.$pos['positionCode'].'</option>';
                                        }?>
                                  </select>
                                </div>
                            </div>
