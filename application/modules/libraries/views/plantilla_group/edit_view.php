<?php 
/** 
Purpose of file:    Edit page for Plantilla Group Library
...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Edit Plantilla Group</span>
        </li>
    </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Edit Plantilla Group</span>
                </div>
            ...
            <?=form_open(base_url('libraries/plantilla_group/edit/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmPlantillaGroup'))?>
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPlantillaGroupName" value="<?=!empty($arrPlantillaGroups[0]['plantillaGroupName'])?$arrPlantillaGroups[0]['plantillaGroupName']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="intPlantillaGroupOrder" value="<?=!empty($arrPlantillaGroups[0]['plantillaGroupOrder'])?$arrPlantillaGroups[0]['plantillaGroupOrder']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="intPlantillaGroupId" value="<?=isset($arrPlantillaGroups[0]['plantillaGroupId'])?$arrPlantillaGroups[0]['plantillaGroupId']:''?>">
