...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <?=form_open(base_url('libraries/org_structure/edit_service/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmOrgStructure'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strServiceName" value="<?=!empty($arrService[0]['group2Name'])?$arrService[0]['group2Name']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strServiceTitle" value="<?=!empty($arrService[0]['group2HeadTitle'])?$arrService[0]['group2HeadTitle']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
