...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Delete Plantilla Duties</span>
        </li>
    </ul>
</div>
<!-- END PAGE BAR -->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Delete Plantilla Duties</span>
                </div>
                
            </div>
            <div class="portlet-body">
            <?=form_open(base_url('libraries/plantilla_duties/delete/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmDutiesResponsibilities'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" value="<?=isset($arrData[0]['itemNumber'])?$arrData[0]['itemNumber']:''?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="intPDutiesIndex" value="<?=isset($arrData[0]['plantilla_duties_index'])?$arrData[0]['plantilla_duties_index']:''?>">
