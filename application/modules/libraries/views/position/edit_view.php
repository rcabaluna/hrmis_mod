<?php 
/** 
Purpose of file:    Edit page for Position Library
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <?=form_open(base_url('libraries/position/edit/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmPosition'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPositionDescription" value="<?=!empty($arrPositions[0]['positionDesc'])?$arrPositions[0]['positionDesc']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPositionAbbreviation" value="<?=!empty($arrPositions[0]['positionAbb'])?$arrPositions[0]['positionAbb']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="intPositionId" value="<?=isset($arrPositions[0]['positionId'])?$arrPositions[0]['positionId']:''?>">
