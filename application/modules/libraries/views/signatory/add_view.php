<?php 
/** 
Purpose of file:    Add page for Signatory Library
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Add Signatory</span>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPosition" value="<?=!empty($this->session->userdata('strPosition'))?$this->session->userdata('strPosition'):''?>">
                                </div>
                            </div>
                        </div>
                    </div>
