<?php 
/** 
Purpose of file:    Edit page for Signatory Library
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> Edit Signatory</span>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPayrollGroupCode" value="<?=isset($arrSignatory[0]['payrollGroupCode'])?$arrSignatory[0]['payrollGroupName']:''?>">
                                </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strPosition" value="<?=isset($arrSignatory[0]['signatoryPosition'])?$arrSignatory[0]['signatoryPosition']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
