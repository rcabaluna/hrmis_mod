...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
            ...
            <?=form_open(base_url('libraries/holiday/edit/'.$this->uri->segment(4)), array('method' => 'post', 'id' => 'frmHoliday'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strHolidayCode" value="<?=isset($arrHoliday[0]['holidayCode'])?$arrHoliday[0]['holidayCode']:''?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="strHolidayName" value="<?=!empty($arrHoliday[0]['holidayName'])?$arrHoliday[0]['holidayName']:''?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="strCode" value="<?=isset($arrHoliday[0]['holidayCode'])?$arrHoliday[0]['holidayCode']:''?>">
