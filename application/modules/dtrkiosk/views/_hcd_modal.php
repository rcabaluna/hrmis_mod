  ...
  <div class="modal-dialog modal-dialog-centered"  style="width: 80%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title bold">Health Check Declaration Form</h4>
      </div>
      ...
      <div class="modal-body" style="width: 90%;">
        <div id="aaaa">
          <form id="hcd_form">
            <div style="margin-left: 5%">
              <div class="form-group row">
                ...
                <div class="col-lg-3 col-md-9 col-sm-12">
                  <input type="text" class="form-control form-control-sm date-picker form-required" id="txtdate" name="txtdate" value="<?=date('Y-m-d')?>" data-date-format="yyyy-mm-dd" disabled>
                </div>
              ...
              <!-- <div class="form-group row">
                <label class="col-form-label col-lg-4 col-sm-12">If official, fill-in company details bellow:</label>
              </div>

              <div class="form-group row">
                <label class="col-form-label col-lg-2 col-sm-12">Company Name:</label>
                <div class="col-lg-9 col-md-9 col-sm-12">
                  <input type="text" class="form-control form-control-sm form-required" id="txtcompname" name="txtcompname">
                </div>
              </div>

              <div class="form-group row">
                <label class="col-form-label col-lg-2 col-sm-12">Company Address:</label>
                <div class="col-lg-9 col-md-9 col-sm-12">
                  <input type="text" class="form-control form-control-sm form-required" id="txtcompadd" name="txtcompadd">
                </div>
              </div> -->
            </div>
            <div id="hcd_div">
            ...
            <div class="form-group row" style="width: 87%;">
            ...
            <!-- <div class="form-group row" style="width: 87%;">
              <label class="col-form-label col-lg-3 col-sm-12">Signature:</label>
              <div class="col-lg-3 col-md-9 col-sm-12">
                <input type="text" class="form-control form-control-sm form-required" id="txtsign" name="txtsign">
              </div>
              <label class="col-form-label col-lg-3 col-sm-12" hidden>Date:</label>
              <div class="col-lg-3 col-md-9 col-sm-12" hidden>
                <input type="text" class="form-control form-control-sm date-picker" id="txtsdate" name="txtsdate" value="<?=date('Y-m-d')?>" data-date-format="yyyy-mm-dd">
              </div>
            </div> -->
          </form>
        </div>
