<?php 
/** 
Purpose of file:    Edit page for Image of employee
 Library
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Employee Image</span>
                </div>
                
            </div>
            <div class="portlet-body">
            <?=form_open(base_url('hr/upload/'.$this->uri->segment(3)), array('method' => 'post', 'enctype' => 'multipart/form-data'))?>
                <div class="form-body">
                    <?php //print_r($arrPost);?>
                    <div class="row">
                        <div class="col-sm-12">
