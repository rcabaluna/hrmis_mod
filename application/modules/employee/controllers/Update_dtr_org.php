...
class Update_dtr extends MY_Controller
{
    ...
    public function submit()
    {
        ...
        if (!empty($arrPost)) {
            ...
            echo "<pre>";
            var_dump($arrPost['dtmMorningIn']);
            var_dump($arrPost['dtmMorningOut']);
            var_dump($arrPost['dtmAfternoonIn']);
            var_dump($arrPost['dtmAfternoonOut']);
            var_dump($arrPost['dtmOvertimeIn']);
            var_dump($arrPost['dtmOvertimeOut']);
