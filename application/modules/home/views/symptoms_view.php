        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> No. of Personnel experiencing w/ symptoms</span>
                </div>
            </div>
            <div class="caption font-dark">
                <div class="form-check form-check-inline" id="chksymptoms">
                    <input class="form-check-input" type="checkbox" name="chk" id="s1" value="s1">
                    <label class="form-check-label" for="s1">Fever for the past 3 days</label>
                    ...
                    <input class="form-check-input" type="checkbox" name="chk" id="s8" value="s8">
                    <label class="form-check-label" for="s8">Headache</label>

                    <input class="form-check-input" type="checkbox" name="chk" id="s9" value="s9">
                    <label class="form-check-label" for="s9">Loss of Smell</label>
                    
                    <input class="form-check-input" type="checkbox" name="chk" id="s10" value="s10">
                    <label class="form-check-label" for="s10">Loss of Taste</label>
                    
                    <input class="form-check-input" type="checkbox" name="chk" id="s11" value="s11">
                    <label class="form-check-label" for="s11">Loss of Appetite</label>
                    
                    <input class="form-check-input" type="checkbox" name="chk" id="s12" value="s12">
                    <label class="form-check-label" for="s12">Sore Throat</label>
                    
                    <input class="form-check-input" type="checkbox" name="chk" id="s13" value="s13">
                    <label class="form-check-label" for="s13">Difficulty of Breathing</label>
                   
                    <input class="form-check-input" type="checkbox" name="chk" id="s14" value="s14">
                    <label class="form-check-label" for="s14">Body Malaise</label>
                </div>
                <div class="row">
                ...
                <table class="table table-striped table-bordered table-condensed  table-hover table-checkable order-column" id="tblemployees"  style="display: none">
                    <thead>
                        <tr>
                            ...
                            <th> Office </th>
                            <th style="width: 420px;text-align: center;"> Symptoms </th>
