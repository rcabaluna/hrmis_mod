...
function myDropFuncTask1() {
  var x = document.getElementById("LibDrop1");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncTask2() {
  var x = document.getElementById("LibDrop2");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncTask3() {
  var x = document.getElementById("LibDrop3");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncTask4() {
  var x = document.getElementById("LibDrop4");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncTask5() {
  var x = document.getElementById("LibDrop5");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncTask6() {
  var x = document.getElementById("LibDrop6");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncCom1() {
  var x = document.getElementById("ComDrop1");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
...
function myDropFuncPro() {
  var x = document.getElementById("proDrop");
  if (x.className.indexOf("w3-show") == -1) {
    x.className += " w3-show";
    x.previousElementSibling.className += "";
  } else { 
